% This script loads the motor adaptation data and produces Figure 3.
...
Integ{1} = readtable('Exp1_ motoradapt_xq.xls');
Integ{2} = readtable('Exp2_ motoradapt_xq.xls');
...
Sl{1} = readtable('Exp1_move_slope.xls');
Sl{2} = readtable('Exp2_move_slope.xls');
